          ...
          <div className="row">
            ...
            <div className="col-md-7 col-12 pl-4">
              ...
              <div className="price mt-3">
                ...
                <h1>Rp. {formatRp(product.price)}</h1>
              </div>
        ...
        <div className="container">
          ...
          <div className="row ml-1 mt-sm-0">
            <div className="col-md-2 col-12">
              <div className="row mt-md-4 mt-sm-0 pt-md-5 pt-sm-0">
            ...
            <div className="col-md-4 col-12 mt-3" style={{marginLeft: '-30px'}}>
              <div className="form-inline mb-1 mt-3" style={{display: 'flex', alignItems: 'center'}}>
                <img className="col-md-2 col-2" src={singleStar} alt="" />
